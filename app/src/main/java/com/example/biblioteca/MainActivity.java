        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (user.equals("") || pass.equals("")|| repass.equals(""))
                    Toast.makeText(MainActivity.this, "Porfavor llena todos los campos", Toast.LENGTH_SHORT).show();
                else {
                    if(pass.equals(repass)){
                        ...
                        if(checkuser==false){
                            ...
                            Toast.makeText(MainActivity.this, "El usuario ya existe, por favor inicia sesion", Toast.LENGTH_SHORT).show();
                        }
                    } else {
